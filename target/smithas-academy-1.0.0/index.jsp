    ...
    <section class="hero" id="home">
        <div class="container">
            <div class="hero-content">
                <div class="hero-text">
                    <p class="hero-badge">Kozhikode's #1 Language Institute</p>
                    <h1 class="hero-title">
        ...
        <div class="container">
            ...
            <div class="about-content">
                <div class="about-text">
                    ...
                    <p>
                        Smitha's Academy is a premier language training institute located in the heart of Kozhikode, Kerala. 
                        With over a decade of experience, we have helped thousands of students achieve their language proficiency goals.
                    </p>
                    <p>
                        Our expert trainers, state-of-the-art facilities, and innovative teaching methods ensure that every student 
            ...
            <div class="testimonials-grid">
                <div class="testimonial">
                    ...
                    <p class="testimonial-text">
                        "The trainers at Smitha's Academy are incredibly supportive. Their personalized approach helped me achieve my target score. Highly recommended!"
                    </p>
                ...
                <div class="testimonial">
                    ...
                    <p class="testimonial-text">
                        "I completed my German B2 level in just 4 months. The teaching methodology is excellent and very practical."
                    </p>
                    <div class="rating">★★★★★</div>
                </div>
                <div class="testimonial">
                    ...
                    <p class="testimonial-text">
                        "As a healthcare professional, OET was crucial for my career. Thanks to the academy, I passed on my first attempt!"
                    </p>
                    <div class="rating">★★★★★</div>
                </div>
            </div>
                ...
                <div class="contact-info">
                    ...
                    <div class="contact-details">
                        <div class="detail-item">
                            <h4>📍 Location</h4>
                            <p>Kochuvayalil Buildingssss<br>1st Floor, Pampady<br>Kozhikode, Kerala 673001<br>India</p>
                        </div>
                        <div class="detail-item">
                            <h4>📱 Phone</h4>
                            <p><a href="tel:+918921386389">+91 8921 386 389</a><br><a href="tel:+919074912975">+91 9074 912 975</a></p>
                        </div>
                        <div class="detail-item">
                            <h4>📧 Email</h4>
                        ...
                        <div class="detail-item">
                            <h4>🕒 Working Hours</h4>
                            <p>Monday - Friday: 9:00 AM - 9:00 PM<br>Saturday: 10:00 AM - 6:00 PM<br>Sunday: Closed</p>
                        </div>
                    </div>
                </div>
    ...
    <footer class="footer">
        <div class="container">
            ...
            <div class="footer-bottom">
                <p>&copy; 2026 Smitha's Academy, Kozhikode. All rights reserved. | <a href="#">Privacy Policy</a> | <a href="#">Terms of Service</a></p>
            </div>
        </div>
    </footer>
